...
<head>
	...
	<link href="cssme/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<!-- Sidebar - Brand -->
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="ahp.php">
				<div class="sidebar-brand-icon ">
					<i class="fas fa-users-cog"></i>
				</div>
				<div class="sidebar-brand-text mx-3">AHP Admin</div>
			</a>
            ...
            <li class="nav-item ">
				<a class="nav-link" href="calon_penerima.php">
				<i class="fas fa-fw fa-copy"></i>
					<span>Calon Penerima</span></a>
			</li> -->
			...
			<li class="nav-item">
				<a class="nav-link" href="kriteria.php">
					<div class="ui white tiny label" style="float: right;"><?php echo getJumlahKriteria(); ?></div>
					<i class="fas fa-fw fa-copy"></i>
					<span>kriteria</span>
				</a>
			</li> -->
			...
			<!-- <li class="nav-item">
				<a class="nav-link" href="alternatif.php">
					<div class="ui white tiny label" style="float: right;"><?php echo getJumlahAlternatif(); ?></div>
					<i class="fas fa-fw fa-copy"></i>
			...
			<li class="nav-item">
				<a class="nav-link" href="bobot_kriteria.php">
					<i class="fas fa-fw fa-solid fa-teeth"></i>
			...
			<ul class="nav-item">
				...
				if (getJumlahKriteria() > 0) {
					for ($i = 0; $i <= (getJumlahKriteria() - 1); $i++) {
						echo "<a class='nav-link' href='bobot.php?c=" . ($i + 1) . "'>" . getKriteriaNama($i) . "</a>";
					}
				}
				?>
			</ul>
			...
			<a class="dropdown-item text-center small text-gray-500" href="#">Read More Messages</a>
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="mr-2 d-none d-lg-inline text-gray-600 small"><strong>Pimpinan</strong></span>
								<img class="img-profile rounded-circle" src="img/user-alt-solid.svg">
							</a>
