...
<body>
	...
	<h1 style="text-align: center;font-size: 16px;line-height: 1.2;">DINAS SOSIAL</h1>
		...
		<div>
			...
			<table border="1" style="border-collapse: collapse; width:500px; text-align:center; width:100%;" class="ui celled collapsing table" align="center" style="width:100%;">
				<thead>
					<tr>
					    <th>No</th>    
	...
	<h2 style="text-align:center;font-size: 12px;">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Kepala Dinas Sosial</h2>
			<br>
			<h2 style="text-align:center;font-size: 12px;">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp (&nbsp <?php echo $_POST['keyword'];?>&nbsp)</h2>
	</section>
</body>
