	...
	<form class="ui form" autocomplete="off" method="post" action="editpenduduk.php" enctype="multipart/form-data">
		...
		<table class="ui fixed table">
			<div class="inline field">
				...
				<tr>
					<td>Usia</td>
					<td><input type="text" name="usia" placeholder="Masukkan Usia" required value="<?php echo $data['Usia'] ?>" class="form-control"></td>
				</tr>

				<tr>
					<td>Pendidikan</td>
					<td><input type="text" name="pendidikan" placeholder="Masukkan Pendidikan" required value="<?php echo $data['Pendidikan'] ?>" class="form-control"></td>
				</tr>

				<tr>
					<td>Pendapatan</td>
					<td><input type="text" name="pendapatan" placeholder="Masukkan Pendapatan" required value="<?php echo $data['Pendapatan'] ?>" class="form-control"></td>
				</tr>

				<tr>
					<td>J.tanggungan</td>
					<td><input type="text" name="tanggungan" placeholder="Masukkan tanggungan" required value="<?php echo $data['Tanggungan'] ?>" class="form-control"></td>
				</tr>

				<tr>
					<td>Pekerjaan</td>
					<td><input type="text" name="pekerjaan" placeholder="Masukkan pekerjaan" required value="<?php echo $data['Pekerjaan'] ?>" class="form-control"></td>
				</tr>
