...
<body>
	...
	<h1 style="text-align: center;font-size: 16px;line-height: 1.2;">DINAS SOSIAL</h1>
		...
		<hr border: 50px; border-radius: 10px; border-top:20px solid black; border-bottom:20px solid black;>
			<h2 style="text-align: center;font-size: 16px;" class=" ui header">Laporan Khusus Penerima Bantuan Pangan Non Tunai</h2>
		...
		<div>
			...
			<table border="1" style="border-collapse: collapse; width:500px; text-align:center;  class="ui celled collapsing table" align="center" >
				...
				<tbody>
				    <?php $nomor = 1; ?>
					<?php
					$query  = "SELECT id,nama,id_alternatif,nilai, nik, kecamatan, nagari, Usia ,Pendidikan ,Pendapatan ,Tanggungan ,Pekerjaan FROM alternatif,ranking WHERE alternatif.id = ranking.id_alternatif ORDER BY nilai DESC LIMIT 2";
					$result = mysqli_query($koneksi, $query);
	...
	<h2 style="text-align:center;font-size: 12px;">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Kepala Dinas Sosial</h2>
			<br>
			<h2 style="text-align:center;font-size: 12px;">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp (&nbsp Harmen, SH &nbsp)</h2>
	</section>
</body>
